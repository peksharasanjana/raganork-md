...
if (!(process.env.SESSION |Raganork~8567ad577e8c701a29905a4aa19e0319:7a3151527a4f6957364d773d| process.env.SESSION_ID)) throw new Error("No session found, add session before starting bot")
module.exports = {
    VERSION: 'v4.0.0',
